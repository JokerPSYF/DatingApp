...
{
    /// <inheritdoc />
    public partial class HelloAgain : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SenderUsename = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RecipentId = table.Column<int>(type: "int", nullable: false),
                    RecipentUsername = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Content = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DateRead = table.Column<DateTime>(type: "datetime2", nullable: true),
                    MessageSent = table.Column<DateTime>(type: "datetime2", nullable: false),
                    SenderDeleted = table.Column<bool>(type: "bit", nullable: false),
                    RecipentDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
